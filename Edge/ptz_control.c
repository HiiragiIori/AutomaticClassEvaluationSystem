...
int PTZAbsoluteControl(char *ptz_ip , char *absolute_move_ip  , char *absolute_zoom_ip, int command)
{
    ...
    switch (command)
    {
		...
		case NO10:
            vector2d.x = NO10_x;
            vector2d.y = NO10_y;
            vector1d.x = NO10_ZOOM;
			break;
		case NO11:
            vector2d.x = NO11_x;
            vector2d.y = NO11_y;
            vector1d.x = NO11_ZOOM;
			break;
		case NO12:
            vector2d.x = NO12_x;
            vector2d.y = NO12_y;
            vector1d.x = NO12_ZOOM;
			break;
		case NO13:
            vector2d.x = NO13_x;
            vector2d.y = NO13_y;
            vector1d.x = NO13_ZOOM;
			break;
		case NO14:
            vector2d.x = NO14_x;
            vector2d.y = NO14_y;
            vector1d.x = NO14_ZOOM;
            break;
		 default:
             //vector2d.x = CENTER_x;
             //vector2d.y = CENTER_y;
...
#if 1
    PTZAbsoluteControl(ptz_ip, absolute_move_ip, absolute_zoom_ip, command);
    sleep(3);
    ONVIF_Stop();
    return 0;
#endif
